...
import com.example.user_profile.dto.UserProfileDto;
...
public class UserProfileService {
    ...
    // 프로필 목록 조회 (DTO, 페이징, 정렬)
    public Page<UserProfileDto> getProfilesDto(Pageable pageable) {
        return userProfileRepository.findAllDto(pageable);
    }
